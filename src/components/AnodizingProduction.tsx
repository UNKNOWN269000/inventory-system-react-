...
export default function AnodizingProduction() {
  ...
  const buildRecord = () => ({
    ...
    bar_binding_date: form.barBindingDate,
    type: form.type,
    surface: form.surface,
    profile: form.profile,
    rack_no: form.rackNo,
    length: form.length,
    rack_wise_qty: form.rackWiseQty,
    total_production_qty: form.totalProductionQty,
    premium_packing_qty: form.premiumPackingQty,
    non_brand_packing_qty: form.nonBrandPackingQty,
    weight_bar_qty: form.weightBarQty,
    one_micron: form.oneMicron,
  ...
  const editPendingRecord = (index: number) => {
    ...
    setForm({
      anodizingDate: record.anodizing_date || "",
      barBindingDate: record.bar_binding_date || "",
      type: record.type || "",
      surface: record.surface || "",
      profile: record.profile || "",
      rackNo: record.rack_no || "",
      length: record.length || "",
      rackWiseQty: record.rack_wise_qty || "",
      totalProductionQty: record.total_production_qty || "",
      premiumPackingQty: record.premium_packing_qty || "",
      nonBrandPackingQty: record.non_brand_packing_qty || "",
      weightBarQty: record.weight_bar_qty || "",
