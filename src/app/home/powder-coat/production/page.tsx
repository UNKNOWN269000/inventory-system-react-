...
export const metadata = { title: "Production · Ultra Aluminum" };

export default function ProductionPage() {
  return (
    <DetailView
      title="Production"
      subtitle="Coating and wood-finish production lines for the powder coat department."
      breadcrumbs={[
        { label: "Home", href: "/home" },
        { label: "Powder Coat", href: "/home/powder-coat" },
        { label: "Production", href: "/home/powder-coat/production" },
      ]}
    >
      <div className="mt-8 grid gap-5 sm:grid-cols-2">
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mt-1 text-sm text-zinc-400">Electrostatic powder application and curing</p>
          </div>
        </Link>
        ...
        >
          ...
          <div className="relative">
            ...
            <h3 className="text-xl font-bold text-white group-hover:text-pink-300">Wood Finish</h3>
            <p className="mt-1 text-sm text-zinc-400">Sublimation and wood-effect powder line</p>
          </div>
        </Link>
      </div>
    </DetailView>
